    ...
    <div className="mt-32 container  ">
      <div className="flex flex-col dark:bg-zinc-950 dark:text-white dark:border dark:border-gray-700  md:flex-row ml-auto bg-[#f87171ce] sm:rounded-l-full h-auto md:h-[300px] w-full md:w-9/12  relative sm:p-4 p-7 rounded-sm sm:gap-0 gap-5 md:p-8">
        <div className="w-full md:w-6/12 flex  ">
          <Image
            src="https://i.ibb.co.com/bFTt5Dn/1724425584182.png"
            width={320}
            height={320}
            alt="authorImage"
        ...
        <div className="w-full md:w-6/12 text-gray-600 dark:text-gray-400 text-right ">
          <h1 className="text-2xl font-medium mb-2">Sakib Talukqder</h1>
          <p className="mb-2 ">
            Address: 123 Hostel St, Moulvibazar, Bangladesh
          </p>
          <p className="mb-2">Phone: +880 1799 232910</p>
          <p className="mb-4">Email: sakibtalukqder07@gmail.com</p>
          <div className="flex justify-end items-center">
            <div className="flex space-x-4 text-2xl  ">
              <a
                href="https://facebook.com/sakibtalukqder"
                target="_blank"
              ...
              <a
                href="https://instagram.com/sakibtalukqder"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="mailto:sakibtalukqder07@gmail.com"
